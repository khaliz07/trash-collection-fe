...
export function CollectorFormDialog({
  open,
  onClose,
  collector,
  areas,
}: CollectorFormDialogProps) {
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    const submitData = {
      ...
      password: form.password, // Always include password (required for create)
    };
          ...
          <DialogFooter>
            <button
              ...
              disabled={
                ...
                updateCollectorMutation.isPending
              }
            >
              Đóng
            </button>
