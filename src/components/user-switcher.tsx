      ...
      <CardContent className="pt-0">
        <div className="flex items-center gap-4">
          <div className="flex-1">
            <Select value={currentUserId} onValueChange={handleUserChange} disabled={isChanging}>
...
// Helper function to add user headers to fetch requests
export function fetchWithUser(url: string, options: RequestInit = {}) {
  const userId = localStorage.getItem('demo-user-id') || 'user-1';
