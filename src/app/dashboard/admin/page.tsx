      ...
      <div className="flex flex-col md:flex-row justify-between gap-4">
        <div>
          <h2 className="text-3xl font-bold tracking-tight">
            {t("admin_dashboard.title", "Bảng điều khiển quản trị")}
          </h2>
          <p className="text-muted-foreground">
            {t(
              "admin_dashboard.desc",
              "Tổng quan hiệu suất hệ thống thu gom rác"
            )}
          </p>
        </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">
              {t(
                "admin_dashboard.active_collectors",
                "Người thu gom hoạt động"
              )}
            </CardTitle>
        ...
        <TabsContent value="overview">
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
            <Card className="lg:col-span-5">
              <CardHeader>
                <CardTitle>
                  {t("admin_dashboard.system_status", "Trạng thái hệ thống")}
                </CardTitle>
                <CardDescription>
                  {t(
                    "admin_dashboard.current_system_performance",
              ...
              <CardContent>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between text-sm">
                      <div className="flex items-center">
                        ...
                        <span>
                          {t(
                            "admin_dashboard.server_uptime",
                            "Thời gian hoạt động server"
                          )}
                        </span>
                      </div>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between text-sm">
                      <div className="flex items-center">
                        ...
                        <span>
                          {t("admin_dashboard.database_load", "Tải database")}
                        </span>
                      </div>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between text-sm">
                      <div className="flex items-center">
                        ...
                        <span>
                          {t(
                            "admin_dashboard.api_response_time",
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between text-sm">
                      <div className="flex items-center">
                        ...
                        <span>
                          {t(
                            "admin_dashboard.notifications_delivered",
                            "Thông báo đã gửi"
                          )}
                        </span>
                      </div>
                ...
                <div className="mt-6">
                  <Button variant="outline" className="w-full">
                    {t(
                      "admin_dashboard.view_detailed_status",
          ...
          <div className="mt-4 grid gap-4 md:grid-cols-2 lg:grid-cols-7">
            <Card className="lg:col-span-4">
              <CardHeader>
                <CardTitle>
                  {t("admin_dashboard.monthly_revenue", "Doanh thu hàng tháng")}
                </CardTitle>
                <CardDescription>
                  {t(
                    "admin_dashboard.revenue_trends",
            ...
            <Card className="lg:col-span-3">
              <CardHeader>
                <CardTitle>
                  {t("admin_dashboard.recent_activities", "Hoạt động gần đây")}
                </CardTitle>
                <CardDescription>
                  {t(
                    "admin_dashboard.latest_system_events",
                    "Sự kiện hệ thống gần đây"
                  )}
                </CardDescription>
              </CardHeader>
              <CardContent>
                ...
                <div className="mt-6">
                  <Button variant="outline" className="w-full">
                    {t(
                      "admin_dashboard.view_all_activities",
