...
import { Recycle as Recycling, ArrowLeft, MapPin } from "lucide-react";
            ...
            <CardHeader className="space-y-1">
              ...
              <CardDescription className="text-center">
                {t(
                  ...
                  "Nhập thông tin để tạo tài khoản hộ gia đình"
                )}
              </CardDescription>
            </CardHeader>
            <CardContent>
                ...
                >
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          {t("register.full_name", "Họ và tên")}
                        </FormLabel>
                        <FormControl>
                          <Input
                            placeholder={t(
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          {t("register.address", "Địa chỉ")}
                        </FormLabel>
                        <FormControl>
                          <div className="space-y-2">
                            <Input
                              placeholder={t(
                                "register.address_placeholder",
                              ...
                              onClick={() => {
                                // Focus will be handled by the dialog trigger
                              }}
                            />
                            <AddressDialog
                              value={field.value}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          {t("register.confirm_password", "Xác nhận mật khẩu")}
                        </FormLabel>
                        <FormControl>
                          <Input
                            placeholder={t(
                  ...
                  >
                    {registerMutation.isPending
                      ...
                      : t("register.create", "Tạo tài khoản")}
                  </Button>
                </form>
              </Form>
            </CardContent>
