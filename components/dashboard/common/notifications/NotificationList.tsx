...
export function NotificationList({ notifications, markAllLabel = 'Đánh dấu tất cả đã đọc' }: NotificationListProps) {
  const [localNoti, setLocalNoti] = React.useState<NotificationItem[]>([...notifications]);
  ...
  return (
    <div className="container py-8 md:py-12">
      <div className="flex items-center justify-between mb-6">
        ...
        <Button variant="secondary" onClick={markAllRead}>{markAllLabel}</Button>
      </div>
      <Card>
