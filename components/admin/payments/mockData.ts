...
export const mockUserPayments: UserPayment[] = [
  { id: 'up1', userId: 'u1', userName: 'Nguyễn Văn A', householdCode: 'H001', address: '123 Nguyễn Văn Linh, Quận 7', servicePackage: 'Gói tiêu chuẩn', period: mockPeriods[1], amount: 120000, method: 'momo', status: 'paid' },
  { id: 'up2', userId: 'u2', userName: 'Trần Thị B', householdCode: 'H002', address: '456 Lê Văn Lương, Quận 7', servicePackage: 'Gói nâng cao', period: mockPeriods[1], amount: 180000, method: 'bank', status: 'unpaid' },
  { id: 'up3', userId: 'u3', userName: 'Lê Văn C', householdCode: 'H003', address: '789 Huỳnh Tấn Phát, Quận 7', servicePackage: 'Gói tiêu chuẩn', period: mockPeriods[1], amount: 120000, method: 'cash', status: 'overdue' },
  { id: 'up4', userId: 'u4', userName: 'Phạm Văn D', householdCode: 'H004', address: '12 Nguyễn Trãi, Quận 1', servicePackage: 'Gói nâng cao', period: mockPeriods[2], amount: 180000, method: 'momo', status: 'paid' },
  ...
  { id: 'up6', userId: 'u6', userName: 'Ngô Văn F', householdCode: 'H006', address: '56 Trần Hưng Đạo, Quận 1', servicePackage: 'Gói nâng cao', period: mockPeriods[2], amount: 180000, method: 'cash', status: 'overdue' },
  { id: 'up7', userId: 'u7', userName: 'Vũ Thị G', householdCode: 'H007', address: '78 Nguyễn Thị Minh Khai, Quận 3', servicePackage: 'Gói tiêu chuẩn', period: mockPeriods[1], amount: 120000, method: 'momo', status: 'paid' },
  { id: 'up8', userId: 'u8', userName: 'Bùi Văn H', householdCode: 'H008', address: '90 Lê Lai, Quận 1', servicePackage: 'Gói nâng cao', period: mockPeriods[0], amount: 180000, method: 'bank', status: 'unpaid' },
  { id: 'up9', userId: 'u9', userName: 'Lý Thị I', householdCode: 'H009', address: '101 Nguyễn Đình Chiểu, Quận 3', servicePackage: 'Gói tiêu chuẩn', period: mockPeriods[2], amount: 120000, method: 'cash', status: 'overdue' },
  { id: 'up10', userId: 'u10', userName: 'Trịnh Văn K', householdCode: 'H010', address: '112 Cách Mạng Tháng 8, Quận 10', servicePackage: 'Gói nâng cao', period: mockPeriods[1], amount: 180000, method: 'momo', status: 'paid' },
  { id: 'up11', userId: 'u11', userName: 'Phan Thị L', householdCode: 'H011', address: '123 Pasteur, Quận 1', servicePackage: 'Gói tiêu chuẩn', period: mockPeriods[0], amount: 120000, method: 'bank', status: 'unpaid' },
  { id: 'up12', userId: 'u12', userName: 'Trương Văn M', householdCode: 'H012', address: '134 Nam Kỳ Khởi Nghĩa, Quận 3', servicePackage: 'Gói nâng cao', period: mockPeriods[2], amount: 180000, method: 'cash', status: 'overdue' },
  { id: 'up13', userId: 'u13', userName: 'Đặng Thị N', householdCode: 'H013', address: '145 Hai Bà Trưng, Quận 1', servicePackage: 'Gói tiêu chuẩn', period: mockPeriods[1], amount: 120000, method: 'momo', status: 'paid' },
  { id: 'up14', userId: 'u14', userName: 'Lê Văn O', householdCode: 'H014', address: '156 Nguyễn Thái Học, Quận 1', servicePackage: 'Gói nâng cao', period: mockPeriods[0], amount: 180000, method: 'bank', status: 'unpaid' },
  ...
  { id: 'up16', userId: 'u16', userName: 'Phạm Văn Q', householdCode: 'H016', address: '178 Lê Lợi, Quận 1', servicePackage: 'Gói nâng cao', period: mockPeriods[1], amount: 180000, method: 'momo', status: 'paid' },
  { id: 'up17', userId: 'u17', userName: 'Võ Thị R', householdCode: 'H017', address: '189 Nguyễn Huệ, Quận 1', servicePackage: 'Gói tiêu chuẩn', period: mockPeriods[0], amount: 120000, method: 'bank', status: 'unpaid' },
  { id: 'up18', userId: 'u18', userName: 'Trần Văn S', householdCode: 'H018', address: '200 Lý Tự Trọng, Quận 1', servicePackage: 'Gói nâng cao', period: mockPeriods[2], amount: 180000, method: 'cash', status: 'overdue' },
  ...
  { id: 'up20', userId: 'u20', userName: 'Lê Văn U', householdCode: 'H020', address: '222 Trần Hưng Đạo, Quận 1', servicePackage: 'Gói nâng cao', period: mockPeriods[0], amount: 180000, method: 'bank', status: 'unpaid' },
];
